...
import { IsOptional, IsString, IsDate, IsNotEmpty, IsEnum, Max, IsNumber, IsBoolean } from 'class-validator';
import { PlatformAccountTransactionStatus, PlatformAccountTransactionType, PlatformAccountTransactionDirection } from './schemas/platform-account-transaction.schema';
