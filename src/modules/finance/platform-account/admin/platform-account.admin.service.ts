...
export class PlatformAccountAdminService {
  ...
  async getPlatformAccount(authedAdmin: AuthenticatedUser): Promise<PlatformAccountResponseDto> {
    ...
    return plainToInstance(PlatformAccountResponseDto, platformAccount, { excludeExtraneousValues: true });
  }
  ...
  async getPlatformAccountTransactions(authedAdmin: AuthenticatedUser, paginationQuery?: PaginationQueryDto): Promise<PaginatedResponseDto<PlatformAccountTransactionResponseDto>> {
    ...
    const items = plainToInstance(PlatformAccountTransactionResponseDto, transactions, { excludeExtraneousValues: true });
  ...
  async getPlatformAccountTransaction(authedAdmin: AuthenticatedUser, platformAccountTransactionId: string): Promise<PlatformAccountTransactionResponseDto> {
    ...
    return plainToInstance(PlatformAccountTransactionResponseDto, platformAccountTransaction, { excludeExtraneousValues: true });
  }
  ...
  async createCorrection(
    ...
    return plainToInstance( PlatformAccountTransactionResponseDto, savedTransaction, { excludeExtraneousValues: true });
  }
}