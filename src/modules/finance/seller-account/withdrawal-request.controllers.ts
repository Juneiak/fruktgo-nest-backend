...
import { SellerAccountServiceForAdmin } from './seller-account.role-services'
import { WithdrawalRequestResponseDto } from './seller-account.response.dtos';
import { WithdrawalRequestFilterQueryDto, UpdateWithdrawalRequestDto } from './seller-account.request.dtos';
...
@UserType('admin')
export class WithdrawalRequestControllerForAdmin {
  ...
  getWithdrawalRequests(
    ...
    return this.sellerAccountServiceForAdmin.getWithdrawalRequests(authedAdmin, filterQuery, paginationQuery);
  }
  ...
  getWithdrawalRequest(
    ...
    return this.sellerAccountServiceForAdmin.getWithdrawalRequest(authedAdmin, withdrawalRequestId);
  }
  ...
  updateWithdrawalRequest(
    ...
    return this.sellerAccountServiceForAdmin.updateWithdrawalRequest(authedAdmin, withdrawalRequestId, updateWithdrawalRequestDto);
  }
