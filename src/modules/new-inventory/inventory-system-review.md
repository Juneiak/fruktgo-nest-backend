...
3.  **Бизнес-фичи:**
    *   Добавить **"Усушку" (Shrinkage)**: Автоматическое списание веса для овощей/фруктов (напр., 1% в сутки испаряется влага). Иначе через неделю на складе будет "недостача", которая по факту является физикой.
