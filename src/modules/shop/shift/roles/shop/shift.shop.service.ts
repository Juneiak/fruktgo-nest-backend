...
export class ShiftShopService {
  ...
  async openShiftByEmployee(
    ...
    await this.shiftService.openShift(
      authedShop.id,
      { actorType: ActorType.EMPLOYEE, actorId: authedEmployee.id, actorName: employee.employeeName },
      dto.comment || null,
    );
  ...
  async closeShiftByEmployee(
    ...
    await this.shiftService.startClosing(shiftId, { actorType: ActorType.EMPLOYEE, actorId: authedEmployee.id, actorName: employee.employeeName }, dto.comment || undefined);
    await this.shiftService.closeShift(shiftId, { actorType: ActorType.EMPLOYEE, actorId: authedEmployee.id, actorName: employee.employeeName }, dto.comment || undefined);
  ...
  async pauseShiftByEmployee(
    ...
    await this.shiftService.pauseShift(shiftId, { actorType: ActorType.EMPLOYEE, actorId: authedEmployee.id, actorName: employee.employeeName }, comment);
  ...
  async resumeShiftByEmployee(
    ...
    await this.shiftService.resumeShift(shiftId, { actorType: ActorType.EMPLOYEE, actorId: authedEmployee.id, actorName: employee.employeeName }, comment);
