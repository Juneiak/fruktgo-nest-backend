...
import { SellerJobApplicationsApiModule } from './job-applications/seller.job-applications.api.module';
...
@Module({
  imports: [  
    RouterModule.register([
      ...
      { path: 'job-applications', module: SellerJobApplicationsApiModule },
