...
export class AdminSupportController {
  constructor(
    private readonly adminSupportRoleService: AdminSupportRoleService
  ) {}
  ...
  updateIssue(
    ...
    return this.adminSupportRoleService.updateIssue(authedAdmin, issueId, dto);
  }
  ...
  getFullIssue(
    ...
    return this.adminSupportRoleService.getIssue(authedAdmin, issueId);
  }
  ...
  getIssues(
    ...
    return this.adminSupportRoleService.getIssues(authedAdmin, issueQuery, paginationQuery);
  }
