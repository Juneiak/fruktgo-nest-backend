...
export class AdminArticlesController {
  constructor(private readonly adminArticleRoleService: AdminArticleRoleService) {}
  ...
  createArticle(
    ...
    return this.adminArticleRoleService.createArticle(authedAdmin, dto, articleImage);
  }
  ...
  updateArticle(
    ...
    return this.adminArticleRoleService.updateArticle(authedAdmin, articleId, dto, articleImage);
  }
  ...
  getArticleDetail(
    ...
    return this.adminArticleRoleService.getArticleDetail(authedAdmin, articleId);
  }
  ...
  getAllArticles(
    ...
    return this.adminArticleRoleService.getAllArticles(authedAdmin, articlesQuery);
  }
  ...
  archiveArticle(
    ...
    return this.adminArticleRoleService.archiveArticle(authedAdmin, articleId);
  }
}