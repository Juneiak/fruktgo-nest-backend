...
5. [Единый остаток магазина](#5-единый-остаток-магазина)
6. [Мягкое резервирование](#6-мягкое-резервирование)
7. [Онлайн-заказ: полный цикл](#7-онлайн-заказ-полный-цикл)
8. [Офлайн-продажа](#8-офлайн-продажа)
9. [Конфликт онлайн/офлайн](#9-конфликт-онлайнофлайн)
...
```
Шаблон: Клубника свежая
│
├── Основное:
│   ├── Название: Клубника свежая
│   ├── SKU: BERRY-STRAWBERRY-001
│   ├── Категория: Ягоды
│   ├── Единица: КГ
│   └── Погрешность веса: ±10%
│
├── Условия хранения (идеальные):
│   ├── Температура: 0-4°C
│   ├── Влажность: 90-95%
│   ├── Освещение: Тёмное
...
│
└── Пресет коэффициентов: BERRIES (ягоды)
```
